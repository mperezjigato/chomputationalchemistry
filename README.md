...
The sets of input/output tar files for specific calculations include the following:
 ...
 - **MPI** GPAW (LCAO) calculation (weak scaling analysis) of Ag (FCC) nanoparticles of inccreasing size with both octahedral and cuboctahedral shape: *count.tar.gz* and *nanoparticlessilver.tar.gz* (Genius)
